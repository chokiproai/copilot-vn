  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>
        Thêm một số tính năng hữu ích vào Copilot.
        </DialogDescription>
      </DialogHeader>
                        ...
                        <div className="flex gap-2 w-full items-center justify-between">
                          <div className="flex flex-1 items-center">
                            <div className="text-sm w-full">
                              ...
                              >
                                {checked && prompt.label === 'Tùy chỉnh' ?
                                <Textarea placeholder="Để trống cho phiên bản gốc của Copilot" onChange={(event) => handleChangePrompt(event.target.value)} value={systemPrompt || prompt.content} /> : <span>{prompt.desc}</span>
                                }
                              </RadioGroup.Description>
                            </div>
                          </div>

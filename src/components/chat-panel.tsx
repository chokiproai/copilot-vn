        ...
        <div className="action-root" speech-state="hidden" visual-search="" drop-target="">
          ...
          <div className={cn('outside-left-container', { collapsed: focused })}>
            <div className="button-compose-wrapper">
              <button className="body-2 button-compose" type="button" aria-label="Chủ đề mới" onClick={resetConversation}>
                <div className="button-compose-content">
                  <SVG className="pl-2" alt="new topic" src={NewTopic} width={40} fill="currentColor" />
                  <div className="button-compose-text">Chủ đề mới</div>
                </div>
              </button>
            </div>
          </div>
          ...
          >
            ...
            <div className="main-bar">
              <Textarea
                ...
                placeholder={voiceListening ? 'Hỏi tôi bất cứ điều gì...' : 'Shift + Enter để thay đổi dòng, nhập / chọn từ nhắc'}
                spellCheck={false}

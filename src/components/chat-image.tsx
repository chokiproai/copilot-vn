  ...
  const onEnter = useCallback((event: FormEvent<HTMLFormElement>) => {
    ...
    if (inputUrl) {
      if (/^https?:\/\/.+/.test(inputUrl)) {
        ...
        toast.error('Vui lòng nhập liên kết hình ảnh hợp lệ')
      }
    }
  }, [])
      ...
      <div className={cn('visual-search', panel)} onClick={preventDefault}>
        <div className="normal-content">
          ...
          <div className="buttons">
            <button type="button" aria-label="Tải lên từ thiết bị này">
              <input
                ref={fileRef}
                className="fileinput"
                type="file"
              ...
              Tải lên từ thiết bị này
            </button>
            <button type="button" aria-label="Ảnh chụp" onClick={openVideo}>
        ...
        {panel === 'camera-mode' && <div className="cam-content">
          ...
          <div className="cambtn" role="button" aria-label="Ảnh chụp" onClick={onCapture}>
